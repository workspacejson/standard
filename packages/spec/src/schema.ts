    ...
    generated: {
      ...
      properties: {
        ...
        coChange: {
          ...
          items: {
            type: 'object',
            required: ['files', 'occurrences', 'generated'] as const,
            $comment:
